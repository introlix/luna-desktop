...
export const ChatInterface = ({ fetchedLLMs }) => {
    ...
    useEffect(() => {
        ...
        // Optionally listen for the generation complete event to know when the AI response is finished
        ...
        return () => {
            ...
            window.removeEventListener("generationComplete", () => setIsResponseComplete(true));
        };
    }, []);
    ...
    return (
        <>
            <Layout className="bg-transparent">
                {aiResponse == '' ? <div className="w-full h-full flex items-center justify-center">
                    ...
                    <div className="my-10 h-full">
                        <div className="flex w-full justify-center">
                            <div className="lg:w-[50%] w-full lg:mx-0 mx-5">
                                ...
                                <div className="ai_response p-2 my-2 font-sans text-[1.1rem]">
                                    { aiResponse }
                                </div>
                            </div>
                        </div>
